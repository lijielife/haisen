...
<div class="main" style="height:auto; padding-top:1px;">
    ...
    <table cellspacing="2" cellpadding="5" width="100%">
        ...
        <tr>
            ...
            <td><a href="manager.php?type=fenlei&tt=edit&id=<?php echo $row['class_id'];?>" title="编辑"><img src="<?php echo $this->img('icon_edit.gif');?>" title="编辑"/></a></td>
        </tr>
        <?php } ?>
        <?php } ?>
    </table>
