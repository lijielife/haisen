...
<table cellspacing="2" cellpadding="5" width="100%" class="order_basic">
    ...
    <tr>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" >
            ...
            <?php } ?>
            <tr align="center">
                <td colspan="7" align="right">所用积分:</td><td><?php echo $rt['orderinfo']['use_point'];?>&nbsp;&nbsp;&nbsp;&nbsp;总价:</td><td><?php echo '￥'.($rt['orderinfo']['order_amount']);?></td>
            </tr>
            <?php }  ?>
        </table>
        </td>
...
$('.order_action').live( 'click', function() {
    ...
    var data = { action:'op_status', opstatus:opstatus, opremark:opremark, opid:id }
    $.post( '<?php echo $thisurl;?>', data, function( data ) {
